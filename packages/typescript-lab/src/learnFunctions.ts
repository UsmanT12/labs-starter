...
"import"
   ...
   Keep your "import" statements at the very top of a file. WARNING: 
   make sure to use the .js suffix instead of .ts--technically we're 
   importing from the autogenerated JavaScript file introTypes.js, not
   introTypes.ts.
*/
import { DegreesCelsius, DegreesFahrenheit, OptionalNum } from "./learnTypes.js";
